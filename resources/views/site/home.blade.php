...
<!-- content start -->
    <div class="container-fluid p-0 home-content">
            ...
            <ul class="secondary-nav-ul list mx-auto nav">
                 <?php foreach ($tabs as $tab_key => $tab_value) { ?>
                     <li class="nav-item">
                         ...
                         <a data-toggle="tab" role="tab" href="#{{ $tab_key }}" class="nav-link {{ ($tab_key == 'latestTab') ?'active':''}}"> {{$tab_value}}</a>
                     </li>
                 <?php }?>
            </ul>
        </nav>
        ...
        <div class="container tab-content">
            <?php foreach ($tabs as $tab_key => $tab_value) { ?>
             <div class="{{ $tab_key == 'latestTab' ? 'tab-pane fade show active' : 'tab-pane fade'}}" id="{{ $tab_key }}" role="tabpanel">
